class UtilitiesController < ApplicationController
  ...
  # GET /utilities/pay_bill
  def pay_bill
    "If water bill hasn't been paid, schedule payment."
  end
  ...
  private
    ...
    def utility_params
      params.require(:utility).permit(:water_bill_paid, :seasonal_gas_on_or_off, :kwh_per_mo, :hvac_serviced)
    end
end
